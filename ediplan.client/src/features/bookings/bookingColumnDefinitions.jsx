...
export const bookingColumnDefinitions = [
  ...
  columnHelper.accessor('startDate', {
    ...
    cell: props => {
      return (
        <StackedCell
          data1={format(parseISO(props.getValue()), 'E do MMM yyyy')}
  ...
  columnHelper.accessor('endDate', {
    header: 'End',
    cell: props => {
      return format(parseISO(props.getValue()), 'E do MMM yyyy');
    }
  }),
  ...
  columnHelper.display({
    header: 'Menus',
    cell: props => <BookingTableMenu bookingId={props.row.original.id} />
  })
];
