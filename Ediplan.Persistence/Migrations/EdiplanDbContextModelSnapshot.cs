...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ediplan.Domain.Common.Asset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Ediplan.Domain.Entities.AssetGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Ediplan.Domain.Entities.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Ediplan.Domain.Entities.BookingGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Ediplan.Domain.Entities.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ediplan.Domain.Entities.Production", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ediplan.Domain.Entities.Equipment", b =>
                {
                    b.HasBaseType("Ediplan.Domain.Common.Asset");
            ...
            modelBuilder.Entity("Ediplan.Domain.Entities.Person", b =>
                {
                    b.HasBaseType("Ediplan.Domain.Common.Asset");
            ...
            modelBuilder.Entity("Ediplan.Domain.Entities.Room", b =>
                {
                    b.HasBaseType("Ediplan.Domain.Common.Asset");
            ...
            modelBuilder.Entity("AssetBooking", b =>
                {
                    b.HasOne("Ediplan.Domain.Common.Asset", null)
                        .WithMany()
                        .HasForeignKey("AssetsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ediplan.Domain.Entities.Booking", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Ediplan.Domain.Entities.AssetGroup", b =>
                {
                    b.HasOne("Ediplan.Domain.Entities.AssetGroup", "ParentGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("Ediplan.Domain.Entities.Booking", b =>
                {
                    b.HasOne("Ediplan.Domain.Entities.Location", "Location")
                        .WithMany("Bookings")
                        .HasForeignKey("LocationId");

                    b.HasOne("Ediplan.Domain.Entities.Production", "Production")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("asset_group_map", b =>
                {
                    b.HasOne("Ediplan.Domain.Entities.AssetGroup", null)
                        .WithMany()
            ...
            modelBuilder.Entity("booking_group_map", b =>
                {
                    b.HasOne("Ediplan.Domain.Entities.BookingGroup", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Ediplan.Domain.Entities.Person", b =>
                {
                    b.HasOne("Ediplan.Domain.Entities.Production", null)
                        .WithMany("People")
                        .HasForeignKey("ProductionId");
                });
